...
private:
    ...
    const std::vector<uint32_t> EHT_20_PILOT_INDICES = {6, 32, 74, 100, 141, 167, 209, 235};                                                                                                                                             // 242 subcarriers
    const std::vector<uint32_t> EHT_40_PILOT_INDICES = {6, 32, 74, 100, 140, 166, 208, 234, 249, 275, 317, 343, 383, 409, 451, 477};                                                                                                     // 484 subcarriers
    const std::vector<uint32_t> EHT_80_PILOT_INDICES = {32, 100, 166, 234, 274, 342, 408, 476, 519, 587, 653, 721, 761, 829, 895, 963};                                                                                                  // 996 subcarriers
    const std::vector<uint32_t> EHT_160_PILOT_INDICES = {32, 100, 166, 234, 274, 342, 408, 476, 519, 587, 653, 721, 761, 829, 895, 963, 1028, 1096, 1162, 1230, 1270, 1338, 1404, 1472, 1515, 1583, 1649, 1717, 1757, 1825, 1891, 1959}; // 1992 subcarriers
    const std::vector<uint32_t> EHT_320_PILOT_INDICES = {32, 100, 166, 234, 274, 342, 408, 476, 519, 587, 653, 721, 761, 829, 895, 963, 1028, 1096, 1162, 1230, 1270, 1338, 1404, 1472, 1515, 1583, 1649, 1717, 1757, 1825, 1891, 1959, 2024, 2092, 2158, 2226, 2266, 2334, 2400, 2468, 2511, 2579, 2645, 2713, 2753, 2821, 2887, 2955, 3020, 3088, 3154, 3222, 3262, 3330, 3396, 3464, 3507, 3575, 3641, 3709, 3749, 3817, 3883, 3951}; // 3984 subcarriers (2x1992)
